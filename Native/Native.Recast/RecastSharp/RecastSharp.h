...
namespace Native {
	namespace Recast {
		...
		ref struct HeightFieldCreateException : public System::Exception {

		};


		ref struct CompactHeightFieldBuildException : public System::Exception {

		};
		ref struct CompactHeightFieldErodeException : public System::Exception {

		};

		ref struct CompactHeightFieldPartitionException : public System::Exception {

		};
		ref struct BuildContourSetException : public System::Exception {

		};

		ref struct BuildPolyMeshException : public System::Exception {

		};

		ref struct BuildPolyMeshDetailException : public System::Exception {
